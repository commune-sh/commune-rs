...
//        let resp = tmp
//            .post_json(format!("/_matrix/client/v3/join/{alias_or_id}"),
// &body)            .await?;
...
//        let resp = tmp
//            .post_json(format!("/_matrix/client/v3/rooms/{room_id}/leave"),
// &body)            .await?;
...
//        let resp = tmp
//            .post_json(format!("/_matrix/client/v3/rooms/{room_id}/forget"),
// &body)            .await?;
...
//        let resp = tmp
//            .post_json(format!("/_matrix/client/v3/rooms/{room_id}/kick"),
// &body)            .await?;
...
//        let resp = tmp
//            .post_json(format!("/_matrix/client/v3/rooms/{room_id}/ban"),
// &body)            .await?;
...
//        let resp = tmp
//            .post_json(format!("/_matrix/client/v3/rooms/{room_id}/unban"),
// &body)            .await?;
